...
<html lang="en">
  ...
  <body id="page-top" style= "background-image: url(../image/comida-fondo2.jpg);">
    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid" style= " background-color: rgba(0, 0, 0, .6);">
          ...
          <!-- Page Content -->
          <h1 style= "color: white;">Administración del Menú</h1>
          <hr>
          <p style= "color: white;">Acá puedes Administrar los menús de tu restaurante, puedes Agregar, Modificar o Eliminar listas de Menús.</p>
